...
app.get("/golfer/one", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, golferController.getGolferById(req, res)];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); });
...
app.get("/round/id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, roundController.getRoundById(req, res)];
            case 1: return [2 /*return*/, _a.sent()];
